...
//! and the code, and for a while the citation was dead** — the original lived
//! in the zkVM-era `wallet/` crate and was deleted with it, while
//! `formal/README.md` kept naming it as the real-code replay. Restored here
//! against `wallet2`, and `formal/check-refs.sh` now fails CI if it goes
//! missing again.
//!
...
//!    spec/03), refuses it — and still accepts the honest branch.
...
use uv_wallet2::accept::{accept, Hop, Lineage, Rejected};
