...
//!
//! It was not theft; WOTS+ still guards spending. It destroyed assets.
//!
...
/// to exhibit a preimage of it. Publishing that preimage does not let anyone
/// spend — WOTS+ still stands in the way — but it removes one of the two
/// barriers on the single note whose loss destroys the asset, and it does so
/// silently.
#[test]
