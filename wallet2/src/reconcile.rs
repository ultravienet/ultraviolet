...
pub struct Genesis<'a> {
    pub asset: &'a uv_air::wots::Digest,
    pub commitment: &'a uv_air::wots::Digest,
    pub amount: u64,
}
...
pub fn reconcile(
    ...
    // be re-mined. `demo/regtest.sh` case 1 is the reorg where everything
    // comes back.
    ...
    // and exactly what `demo/regtest.sh` case 1 exercises — nothing ever
