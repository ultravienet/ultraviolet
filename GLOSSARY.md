...
whitepaper (`SPEC.md`). Terms that belonged to deleted subsystems are gone rather than left
defining things the system does not have; the journal records what each one was.
