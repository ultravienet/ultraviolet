...
| **address record** | published batch of one-time payment slots plus a scan key, handed over once | [02](spec/02-NOTES.md) |
...
| **carrier** | the messenger that moves payloads and knows nothing about them — Signal by design | [05](spec/05-NETWORK.md) |
| **blob store** | durable content-addressed storage: a *separate* role, because the carrier deletes after delivery | [05](spec/05-NETWORK.md) |
...
| **ancestry** | a note's chain of transitions, oldest first; a receiver binds it to the proof and checks every hop settled | [03](spec/03-RECORDS.md) |
| **the client** | a chat app forked from Signal, iOS first | [08](spec/08-CLIENT.md) |
