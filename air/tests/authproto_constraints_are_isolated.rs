...
//!
//! `authproto_air.rs` is the sole money-path circuit since the WOTS+ signature
...
use uv_air::authproto_air::{generate, AuthProtoAir, HEIGHT, NUM_COLS, NUM_PUBLIC_VALUES, RBITS};
