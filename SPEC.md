...
| `demo/mirror.sh` | a light client reading Bitcoin without ever naming a coin: bulk pages in, lookups answered locally, and the leaking endpoint shown not to exist |
