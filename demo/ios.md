...
> **These numbers describe a deleted circuit.** They were measured 2026-07-27 on the
> signature-verifying transfer circuit, which was removed 2026-07-29 when the money path went
> proof-native (SPEC.md §8.4). They are kept as the dated ledger they are — the methodology
> and the budget conclusion stand — but they are **withdrawn as claims about today's
> circuit**, which proves an order of magnitude faster on the laptop and is re-measured on
> device in the signed app (Phase 4 of the iOS track).
